        ...
        this.installPrompt.innerHTML = `
            <div class="pwa-install-content">
                ...
                <div class="pwa-install-text">
                    ...
                    <p><span data-translate="install_message">Installez CityLoop Quest Dubrovnik pour une meilleure expérience</span></p>
                </div>
    ...
    showManualInstallInstructions() {
        ...
        instructions.innerHTML = `
            <div class="pwa-manual-content">
                ...
                <p><span data-translate="install_intro">Pour installer CityLoop Quest Dubrovnik sur votre appareil :</span></p>
    ...
    showIOSInstallInstructions() {
        ...
        instructions.innerHTML = `
            <div class="pwa-manual-content">
                ...
                <p><span data-translate="ios_intro">Pour installer CityLoop Quest Dubrovnik sur votre appareil iOS :</span></p>
                <div class="install-steps">
                    <div class="step">
