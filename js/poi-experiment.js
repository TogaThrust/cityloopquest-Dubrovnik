...
(function () {
  ...
  const CITY_CONFIG = {
    ...
    defaultCenter: { lat: Number("42.64091"), lng: Number("18.1104") },
    lastPosKey: "dubrovnik_lastKnownPosition",
    cityKey: "dubrovnik",
  ...
  function isWalkInProgress() {
    return (
      ...
      localStorage.getItem("dubrovnik_walkInProgress") === "true" ||
  ...
  function updateTourSavedSummary() {
    ...
    if (!el) return;
    const idxRaw = localStorage.getItem("dubrovnik_currentIndex");
    const scoreRaw = localStorage.getItem("dubrovnik_score");
