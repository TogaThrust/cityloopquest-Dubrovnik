/**
 * Réécrit les descriptions POI Dubrovnik en textes visiteurs, sans formulation interne.
 * Usage: node scripts/rewrite-dubrovnik-poi-descriptions.mjs
 */
import fs from "fs";
